...
⏳ Thời gian đã hoạt động: ${uptimeHours.toString().padStart(2, '0')}:${uptimeMinutes.toString().padStart(2, '0')}:${uptimeSeconds.toString().padStart(2, '0')}
...
👤 Yêu cầu bởi: ${name}
  `.trim();
            api.sendMessage({body: replyMsg, attachment: global.lekhanh.splice(0, 1)}, event.threadID, event.messageID);
        } catch (error) {
