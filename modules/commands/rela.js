...
//Hàm tạo mảng random
MissionC = Array.from({length: 5}, () => Math.floor(Math.random() * 10));

//Hàm tính tổng
var allmath = (MissionC[0]+MissionC[1]+MissionC[2]+MissionC[3]+MissionC[4]) * 3.75;
